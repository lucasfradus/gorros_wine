...
import { canEditUser, requireUserManager, ROLE_LABEL } from "@/lib/auth";
      ...
      <div className={styles.pageHead}>
        <div>
          ...
          <p className={styles.pageSub}>
            Quién entra al panel y qué puede hacer. Son las cuentas del
            sistema, no los clientes de la vinoteca.
          </p>
        </div>
        <Link
                    ...
                    <td>
                      <span
                        className={`${styles.badge} ${
                          u.role === "owner" ? styles.badgeOwner : ""
                        }`}
                      >
                        {ROLE_LABEL[u.role]}
                      </span>
